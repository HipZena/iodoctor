...
Task<Link> result = await ApidocController.GetAsync();
...
Task result = await ApidocController.GetApiDocAsync();
...
Task result = await ApidocController.GetSwaggerAsync();
...
Task<AppendixCode> result = await AppendixController.GetValuesAsync("employerclass");
...
Task<AppendixCode> result = await AppendixController.GetAsync("employerclass", 99);
...
Task result = await CompaniesController.FindAllAsync(1, 5);
...
Task<Company> result = await CompaniesController.GetAsync("some string");
...
Task<Company> result = await CompaniesController.UpdateAsync(company, "some string");
...
Task<Company> result = await CompaniesController.UpdatePartialAsync("some string", "some string");
...
Task result = await EmployersController.FindAllAsync();
...
Task result = await EmployersController.AddAsync(employer);
...
Task<Employer> result = await EmployersController.GetAsync("some string");
...
Task result = await EmployersController.DeleteAsync("some string");
